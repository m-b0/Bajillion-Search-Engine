...
def line_to_terms(line_string):
    #input the line in the file as a string and output a list of terms
    final_terms_list = []
...
def create_index(filenames, index, file_titles):
    ...
    #open the content for each file
    #use the file name and title to update the file_titles dict
    #loop through the content, strip the punctuation and parse out the terms, update index dict
